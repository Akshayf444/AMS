...
if (isset($_POST['submit'])) {
    ...
    for ($i = 0; $i < $length; $i++) {
        ...
        if (empty($Errors)) {
            ...
            //$ItemDetails = ItemDetails::find_by_item_id($newGRN->item_id);
            $temp = $receivedTillDate + $newGRN->quantity_received;
            echo $temp;
            if ($receivedTillDate == $isDelivered->quantity) {
                
            } elseif ($temp > $isDelivered->quantity) {
    ...
    <div class="">
        <div class="col-lg-4 col-md-6 " >
            <div class="form-group input-group ">
                <input type="text"  class="form-control" placeholder="Key No. Or PO No. Or Approval Id" id="search" name="searchterm"/>
...
<div class="row" style="margin-bottom:1em;">
    <div class="col-lg-12 table-responsive">
        <form action="PREsearchGRN.php" method="post">
