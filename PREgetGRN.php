        ...
        <table class="table table-bordered table-hover table-striped" id="items">
            ...
            <tbody>
                <tr class="targetfields">
                    ...
                    <td><?php echo $ItemDetails->description; ?></td>
                    <td><input type="text" readonly value="<?php echo $ItemDetails->quantity; ?>" class="order form-control"></td>
                    <td><input type="text" readonly value="<?php
                        ...
                        ?>" class="receivedtillDate form-control"  >
                    ...
                    <td><input type="hidden" name="item_id[]" value="<?php echo $ItemDetails->item_id; ?>">
                        ...
                        <?php if ($ItemDetails->quantity == $receivedTillDate) { ?>
                            ...
                            This Item Has Been Delivered.
                        <?php } else { ?>
                            <input type="textbox" name="quantity_received[]" class="form-control receive" value=""  >
                        <?php } ?>
                    </td>
...
<script>
                                ...
                                jQuery("#items ").delegate('.common ', 'keyup', function () {
                                    ...
                                    jQuery("#items .targetfields").each(function () {
                                        ...
                                        var qty = parseFloat(jQuery(this).find(".receive").val()) || 0;
                                        var rate = parseFloat(jQuery(this).find(".receivedtilldate").val()) || 0;
                                        var ordered = parseFloat(jQuery(this).find(".order").val()) || 0;
                                        //calculate subtotal
                                        var subtotal = qty + rate;

                                        if(subtotal > ordered){
                                            alert("Quantity is Greater than ordered quantity.");
                                        }
