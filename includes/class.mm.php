...
class MM {
    ...
    protected static $table_name = "mm";
    protected static $db_fields = array('MM_empid', 'name', 'emailid', 'password', 'mobile','division','complete_profile');
    public $MM_empid;
    public $name;
    public $emailid;
    public $password;
    ...
    public static function find_by_empid($empid) {
        $result_array = self::find_by_sql("SELECT * FROM " . self::$table_name . " WHERE MM_empid = '$empid' ");
        return !empty($result_array) ? array_shift($result_array) : false;
    }
