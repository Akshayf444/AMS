...
if (isset($_POST['submit'])) {
    $newEmployee = new MM();
    $newEmployee->MM_empid = $_POST['empid'];
    
    if (!empty($_POST['name'])) {
        $newEmployee->name = $_POST['name'];
    } else {
        array_push($errors, "Please Enter MM Name.");
    }
    ...
    if (empty($errors)) {
        $found_employee = MM::find_by_empid($newEmployee->empid);
...
<div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <i class="fa fa-desktop"></i> Add Marketing Manager
            </li>
        </ol>
    </div>
</div>
